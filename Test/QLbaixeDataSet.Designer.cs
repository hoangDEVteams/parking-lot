...
namespace Test {
    ...
    public partial class QLbaixeDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/QLbaixeDataSet.xsd";
        ...
        public partial class VehiclesDataTable : global::System.Data.TypedTableBase<VehiclesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public VehiclesRow AddVehiclesRow(string LicensePlate, int IDVehicleType, string Color, string Status, string Description, string IDEmployee) {
...
namespace Test.QLbaixeDataSetTableAdapters {
    ...
    public partial class VehiclesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Vehicles] ([LicensePlate], [IDVehicleType], [Color], [Status], [Description], [IDEmployee]) VALUES (@LicensePlate, @IDVehicleType, @Color, @Status, @Description, @IDEmployee);
SELECT LicensePlate, IDVehicleType, Color, Status, Description, IDEmployee FROM Vehicles WHERE (LicensePlate = @LicensePlate)";
...
SELECT LicensePlate, IDVehicleType, Color, Status, Description, IDEmployee FROM Vehicles WHERE (LicensePlate = @LicensePlate)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT LicensePlate, IDVehicleType, Color, Status, Description, IDEmployee FROM d" +
                "bo.Vehicles";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT LicensePlate, IDVehicleType, Color, Status, Description, IDEmployee FROM d" +
                "bo.Vehicles";
        ...
        public virtual int Fill(QLbaixeDataSet.VehiclesDataTable dataTable) {
        ...
        public virtual QLbaixeDataSet.VehiclesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLbaixeDataSet.VehiclesDataTable dataTable = new QLbaixeDataSet.VehiclesDataTable();
        ...
        public virtual int FillBy(QLbaixeDataSet.VehiclesDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLbaixeDataSet.VehiclesDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLbaixeDataSet dataSet) {
        ...
        public virtual int Delete(string Original_LicensePlate, int Original_IDVehicleType, string Original_Color, string Original_Status, string Original_Description, string Original_IDEmployee) {
        ...
        public virtual int Insert(string LicensePlate, int IDVehicleType, string Color, string Status, string Description, string IDEmployee) {
        ...
        public virtual int Update(string LicensePlate, int IDVehicleType, string Color, string Status, string Description, string IDEmployee, string Original_LicensePlate, int Original_IDVehicleType, string Original_Color, string Original_Status, string Original_Description, string Original_IDEmployee) {
            if ((LicensePlate == null)) {
                throw new global::System.ArgumentNullException("LicensePlate");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_IDVehicleType));
            if ((Original_Color == null)) {
                throw new global::System.ArgumentNullException("Original_Color");
            }
            else {
            ...
            if ((Original_IDEmployee == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_IDEmployee));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int IDVehicleType, string Color, string Status, string Description, string IDEmployee, string Original_LicensePlate, int Original_IDVehicleType, string Original_Color, string Original_Status, string Original_Description, string Original_IDEmployee) {
            return this.Update(Original_LicensePlate, IDVehicleType, Color, Status, Description, IDEmployee, Original_LicensePlate, Original_IDVehicleType, Original_Color, Original_Status, Original_Description, Original_IDEmployee);
        }
    }
